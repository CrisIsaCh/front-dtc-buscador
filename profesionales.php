...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark bg-dark">
      <a href="http://google.com" class="navbar-brand">PROFESIONALES</a>
    </nav>
 ...
 <div id="modalProfesionales" class="modal fade"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content " >
      ...
      <div class="modal-body ">
        <form>              
          ...
          <div class="mb-3 ">
            <label for="apellidop" class="col-form-label">APELLIDO</label>
            <input id="apellidop"type="text" class="form-control" autofocus>
          </div> 

          
          <div class="mb-3 ">
            <label for="nombrep" class="col-form-label">NOMBRE</label>
            <input id="nombrep"type="text" class="form-control" autofocus>
          </div> 

          <div class="mb-3 ">
            <label for="categoriap" class="col-form-label">CATEGORIA</label>
            <input id="categoriap"type="text" class="form-control" autofocus>
          </div>        
      </div>
